...
public class Statusleiste extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		repaint();
		if(fenster.spieler.hatSchluessel())g.drawImage(schluessel, 475, 0, this);
	}
}
